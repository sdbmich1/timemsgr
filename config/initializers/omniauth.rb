Rails.application.config.middleware.use OmniAuth::Builder do  
  provider :facebook, '131627943626812', '440e7e13fcf9ccc418d727e9b2f59b79', {:scope => 'email, user_birthday, user_events, user_interests', :client_options => {:ssl => {:ca_path => "/etc/ssl/certs"} }} 
