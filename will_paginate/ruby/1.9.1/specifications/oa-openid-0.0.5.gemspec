...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<oa-core>, ["= 0.0.5"])
      s.add_runtime_dependency(%q<rack-openid>, ["~> 1.1.1"])
      ...
      s.add_dependency(%q<oa-core>, ["= 0.0.5"])
      s.add_dependency(%q<rack-openid>, ["~> 1.1.1"])
